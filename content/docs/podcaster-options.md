...
| `handleExcerpts` | undefined | When this is set to `true`, **Podcaster** will calculate excerpts in Markdown for your posts. These will be available as `excerpt` in the data cascade. Read more [about excerpts here][excerpts]. |
