...
**Podcaster** is based on code I wrote as I created [a series of podcast websites][] over a few years. It doesn't solve any very complex problems, but I needed to extract all the duplicate podcast-related code from my various podcast websites and put it somewhere so I could include it in all of them.
...
This site was made using [Eleventy][], specifically the [eleventy-base-blog][] starter. The site's colour scheme is based on the [Base2Tone Pool][] theme by Bram de Haan.
